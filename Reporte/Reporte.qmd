...
```{r}
#| fig-cap: "Variables de interés y su descripción"
...
```{r}
#| fig-cap: "Cantidad de ingresos por nacionalidad del ingresante"
...
```{r}
#| fig-cap: "Cantidad de observaciones por alojamiento"
...
```{r}
#| fig-cap: "Cantidad de observaciones por transporte utilizado locamente"
...
```{r}
#| fig-cap: "Algunas nuevas columnas de gastos por persona"
