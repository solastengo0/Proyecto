...
### Distribución del gasto segun el Estudio (los que tenemos más datos)
...
### Distribución del gasto segun el motivo
...
```{r}
receptivo_fecha_dia |> 
  filter(GastoTotal_porPersona_Dia < 350 & Motivo %in% c("Ocio y vacaciones", "Visita a familiares y amigos" , "Trabajo / Profesional", "Transito", "Segunda Residencia")) |> 
  ggplot(aes(
    x = GastoTotal_porPersona_Dia, 
    y = Motivo, 
    fill = Motivo
